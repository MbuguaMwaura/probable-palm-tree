...
class CustomListPageHeading extends Component {
    constructor(props) {
        super();
        this.state = {
                                ...
                                <DropdownMenu right>
                                    ...
                                    {/*{
                                        this.props.dropDownData.map((data, index) => {
                                            return (
                                                <DropdownItem key={index} onClick={() => toggleCrudModal(data.modalTitle, data.modalValue, 0)}>
                                                    <IntlMessages id={data.dropDownText} />
                                                </DropdownItem>
                                            )
                                        })
                                    }*/}
...
export default injectIntl(CustomListPageHeading);
