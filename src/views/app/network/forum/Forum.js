...
class Forum extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      localeData: {
        heading: "menu.forum",
        button1: "users.approve",
        button2: "users.disapprove",
        modalTitle1: "users.approve-user-title",
        modalTitle2: "users.disapprove-user-title",
      },
          ...
          <Row>
            {discussions.data.map((discussion, i) => (
              <DiscussionCard
                ...
                creatorName={discussion.creator.name}
                discussiondescription={discussion.description}
                photoUrl={discussion.creator.photoUrl}
                discussionlikes={discussion.likes.length}
                discussioncomments={discussion.forumComments.length}
