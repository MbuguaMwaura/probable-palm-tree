...
import BaseLogisticsOrderDetails from "./BaseOrderDetails";
...
class BaseLogisticsOrderDetailsPage extends Component {
    constructor(props) {
        super(props);
                ...
                <Row>
                    <Colxx xxs="12">
                        ...
                        <TabContent activeTab={this.state.activeFirstTab}>
                            <TabPane tabId="1">
                                <BaseLogisticsOrderDetails item={item}/>
                            </TabPane>
                        </TabContent>
                    </Colxx>
                </Row>
...
export default injectIntl(BaseLogisticsOrderDetailsPage);
