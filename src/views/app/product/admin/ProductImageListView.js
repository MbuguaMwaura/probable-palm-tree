...
const ProductImageListView = ({ data, isSelect, collect, onCheckItem }) => {
  return (
        ...
        >
          <div className="position-relative">
            <NavLink to={`?p=${data.id}`} className="w-40 w-sm-100">
              <CardImg top alt={data.name} src={data.primaryImage} />
            </NavLink>
            <Badge
...
export default React.memo(ProductImageListView);
