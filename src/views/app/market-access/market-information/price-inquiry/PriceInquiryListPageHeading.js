...
class PriceInquiryListPageHeading extends Component {
    constructor(props) {
        super();
        this.state = {
                            ...
                            {this.props.titleButtonsData.map((data, index) => {
                                return <Button
                                    ...
                                    onClick={()=>toggleCrudModal(
                                        ...
                                        data.modalValue,
                                        selectedItemsLength,
                                        "Only one record can be answered at a time",
                                        "Please select a record to answer"
                                    )}
                                >
...
export default injectIntl(PriceInquiryListPageHeading);
